...
| **콘텐츠** | 무기 10종 · 액세서리 21종 · 적 12종 · 일반 방 프리팹 20종 (+ 보스 · 미니보스 · 상점 · 튜토리얼 · 마을) |
...
### 방 생성 / 진행
- 사전 제작한 일반 방 20종을 셔플(Fisher-Yates)해 순서를 세이브에 기록 → 컨티뉴 시 같은 배치 복원.
- 런 하나가 일반 방 7개를 소비합니다(4번 상점 · 7번 미니보스 · 10번 보스는 고정). 셔플 목록이 바닥나면 다시 섞습니다.
